          ...
          {isCargo ? (
            ...
            <div className="space-y-3.5 sm:space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-500 mb-1">Країна завантаження</label>
                  <input 
                    list="countries-list" 
                    required 
                    type="text" 
                    placeholder="Напр: UA - Україна" 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-500 mb-1">Країна розвантаження</label>
                  <input 
                    list="countries-list" 
                    required 
                    type="text" 
                    placeholder="Напр: PL - Польща" 
                    className={inputClasses} 
            ...
            <div className="space-y-3.5 sm:space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-[1fr_2fr] gap-2.5 sm:gap-3">
                ...
                <div>
                  ...
                  <input 
                    required 
                    type="text" 
                    placeholder="Звідки (місто, селище)" 
                    className={inputClasses} 
                    value={formData.city_from} 
                    onChange={(e) => setFormData({ ...formData, city_from: e.target.value })} 
                  />
              ...
              <div>
                ...
                <input 
                  type="text" 
                  placeholder="Контакти (Ім'я, Телефон)" 
                  className={inputClasses} 
                  value={formData.phone} 
                  onChange={(e) => setFormData({ ...formData, phone: e.target.value })} 
                />
